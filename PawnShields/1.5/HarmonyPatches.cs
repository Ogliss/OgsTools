...
namespace PawnShields
{
    ...
    public static class HarmonyPatches
    {
        ...
        static HarmonyPatches()
        {
            ...
            //
            //            //PawnRenderer
            Log.Message("PawnRenderer");
            {
                Type type = typeof(PawnRenderer);
                Type type2 = typeof(PawnRenderUtility);

                pawnField_PawnRenderer = type.GetField("pawn", BindingFlags.NonPublic | BindingFlags.Instance);

                MethodInfo patchMethod = type2.GetMethod("DrawEquipmentAndApparelExtras");
            ...
            //Pawn_HealthTracker
            Log.Message("Pawn_HealthTracker");
            {
            ...
            Log.Message("Pawn_EquipmentTracker");
            {
...
//
        ...
        public static void Patch_PawnRenderer_RenderPawnAt(Pawn pawn, Vector3 drawPos, Rot4 facing, PawnRenderFlags flags)
        {

            //Render shield.
            if(pawn != null && pawn.GetShield() is ThingWithComps shield)
            {
                Vector3 bodyVector = drawPos;
