    ...
    public static class HarmonyPatches
    {
        ...
        static HarmonyPatches()
        {
            ...
            Log.Message("PawnRenderer");
            {
                ...
                MethodInfo patchMethod = type.GetMethod("RenderPawnAt", new Type[] { typeof(Vector3), typeof(Rot4?), typeof(bool) });
...
//
        ...
        public static void Patch_PawnRenderer_RenderPawnAt(PawnRenderer __instance, ref Vector3 drawLoc, Rot4? rotOverride, bool neverAimWeapon)
        {
