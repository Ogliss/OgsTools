        ...
        public override void PostDeSpawn(Map map)
        {
            if (canspawn)
            {
                ...
                if (spawnRoll < (spawnChance * plant.Growth))
                {
                    ...
                    PawnGenerationRequest pawnGenerationRequest = new PawnGenerationRequest(pawnKindDef, faction, generationContext, -1, true, true, false, false, true, 0f, fixedBiologicalAge: Age, fixedChronologicalAge: Age);
