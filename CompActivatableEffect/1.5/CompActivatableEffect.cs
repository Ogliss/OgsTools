...
namespace OgsCompActivatableEffect
{
    public class CompActivatableEffect : CompUseEffect
    {
        ...
        public new virtual CompProperties_ActivatableEffect Props => (CompProperties_ActivatableEffect)props;
        ...
        //    Log.Message(string.Format("Layer: {0} alt: {1}, layer int: {2}", Props.altitudeLayer, alt, (int)Props.altitudeLayer));
            return alt;
        }
        ...
        {
            if (!GizmosOnEquip && GetEquippable!=null)
            {
