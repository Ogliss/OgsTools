...
/*
            ...
            */
            ...
            MethodInfo target3 = AccessTools.Method(typeof(Verse.PawnRenderUtility), "DrawEquipmentAiming", null, null);
            if (target3 == null)
            {
                Log.Warning("Target: Verse.PawnRenderUtility.DrawEquipmentAiming Not found");
            }
            MethodInfo patch3 = typeof(PawnRenderUtility_DrawEquipmentAiming_Vanilla_Transpiler).GetMethod("Transpiler");
            if (patch3 == null)
            {
