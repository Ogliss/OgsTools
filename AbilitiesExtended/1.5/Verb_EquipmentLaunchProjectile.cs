    ...
    public class Verb_EquipmentLaunchProjectile : Verb_UseEquipment
    {
        ...
        public override bool TryCastShot()
        {
            ...
            if (base.EquipmentSource != null)
            {
                ...
                base.EquipmentSource.TryGetCompFast<CompApparelVerbOwner_Charged>()?.UsedOnce();
            }
            ...
            {
                line.ChangeDestToMissWild_NewTemp(hitReport.AimOnTargetChance_StandardTarget, projDef.projectile.flyOverhead, caster.Map);
