...
namespace AbilitesExtended
{
    ...
    [DefOf]
    public static class AbilitesExtendedTraitDefOf
    {
        static AbilitesExtendedTraitDefOf()
        {
            DefOfHelper.EnsureInitializedInCtor(typeof(AbilitesExtendedTraitDefOf));
        }
    ...
    public class Command_EquipmentAbility : Command_Ability
    {
        ...
        public Command_EquipmentAbility(EquipmentAbility ability, Pawn pawn) : base(ability, pawn)
        {
        }
