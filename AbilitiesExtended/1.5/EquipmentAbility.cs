...
namespace AbilitesExtended
{
    ...
    public class EquipmentAbility : Ability
    {
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look<int>(ref this.cooldownEndTick, "cooldownEndTick", 0, false);
            Scribe_Values.Look<int>(ref this.cooldownDuration, "cooldownDuration", 0, false);
        ...
        public override IEnumerable<Command> GetGizmos()
        {
            if (this.gizmo == null)
            {
                var command_CastPower = new Command_EquipmentAbility(this, this.pawn)
                {
