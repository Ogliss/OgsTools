    ...
    public class TunnelRaidSpawner : ThingWithComps, IThingHolder
    {
        ...
        public override void Tick()
        {
            if (base.Spawned)
            {
                ...
                Rand.PushState();
                if (Rand.MTBEventOccurs(TunnelRaidSpawner.FilthSpawnMTB, 1f, 1.TicksToSeconds()) && CellFinder.TryFindRandomReachableCellNearPosition(base.Position, base.Position, base.Map, TunnelRaidSpawner.FilthSpawnRadius, TraverseParms.For(TraverseMode.NoPassClosedDoors, Danger.Deadly, false), null, null, out c, 999999))
                {
