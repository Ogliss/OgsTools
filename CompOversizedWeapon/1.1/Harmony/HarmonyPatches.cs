...
namespace OgsCompOversizedWeapon
{
    ...
    public static class HarmonyPatches_OversizedWeapon
    {
        ...
        static HarmonyPatches_OversizedWeapon()
        {
            ...
            {
                bool newVer = AccessTools.Method(GenTypes.GetTypeInAnyAssembly("DualWield.Harmony.PawnRenderer_DrawEquipmentAiming", "DualWield.Harmony"), "Transpiler", null, null) != null;
                if (!newVer)
                {
                    {
            ...
            {
                bool newVer = AccessTools.Method(GenTypes.GetTypeInAnyAssembly("yayoCombat.AnimationUtility", "yayoCombat"), "animateEquip", null, null) != null;
                if (!newVer)
                {
